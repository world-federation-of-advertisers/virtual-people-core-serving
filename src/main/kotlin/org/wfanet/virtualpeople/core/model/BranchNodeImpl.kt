...
private constructor(
  ...
  companion object {
     ...
     * least one of @node_config.branch_node.branches, which has neither chance nor condition set.
     * At least one of @node_config.branch_node.branches has chance set, and at least one of
